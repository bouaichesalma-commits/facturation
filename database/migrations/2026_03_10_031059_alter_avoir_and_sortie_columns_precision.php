...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('avoir_article', function (Blueprint $table) {
            $table->decimal('prix_article', 16, 6)->change();
        });

        Schema::table('avoir_custom_articles', function (Blueprint $table) {
        ...
        Schema::table('bon_sortie_article', function (Blueprint $table) {
            $table->decimal('prix_article', 16, 6)->change();
        });

        Schema::table('bon_sortie_custom_articles', function (Blueprint $table) {
            $table->decimal('prix', 16, 6)->change();
        });
    }
