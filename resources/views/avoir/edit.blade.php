        ...
        <div class="col-lg-12">
            <div class="card p-md-3 p-lg-4">
                <div class="card-body">
                    ...
                    <form id="factureForms" method="POST" action="{{ route('avoir.update', $bon->id) }}" class="row g-3" onsubmit="return prepareForm()">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-center mt-5">
                            <a href="{{ route('avoir.index') }}" class="btn btn-secondary">Retour</a>
