<div class="modal fade" wire:ignore.self id="deleteStockModal{{ $stock->id }}" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
        ...
        <div class="modal-content p-2">
            ...
            <div class="modal-body text-center p-3">
                ...
                <div class="my-4 gap-5">
                    <p class="fw-bold mb-0">Voulez-vous vraiment supprimer ce stock ?</p>
                    <p class="text-secondary">Ce processus ne peut pas être annulé !</p>
                    <p class="text-dark fw-bold mt-2">{{ $stock->designation }}</p>
                </div>
                <div>
