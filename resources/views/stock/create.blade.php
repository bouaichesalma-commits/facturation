...
@endphp
            ...
            <div class="col-lg-8">
                <div class="card p-md-3 p-lg-4">
                    <div class="card-body">
                        ...
                        @endif
                        <!-- Changed form action to stock.store -->
                        <form method="POST" action="{{ route('stock.store') }}" class="row g-3"  id="StockForm">
                            @csrf
                            ...
                            {{-- <div class="col-md-6">
                                <label for="inputPrix" class="form-label">@lang('Prix de vente ') :</label>
                             ...
                             <div class="col-md-6">
                                <label for="inputPrixAchat" class="form-label">Prix d'achat ttc :</label>
                                <input type="text" name="prix_achat" value="{{old('prix_achat')}}" class="form-control @error('prix') is-invalid @enderror" id="inputPrixAchat" placeholder="Veuillez saisir ici ...">
                                @error('prix_achat')
                                    <div class="text-danger ps-3">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="Quantite" value="{{old('Quantite')}}" class="form-control @error('Quantite') is-invalid @enderror" id="inputQuantite" placeholder="Veuillez saisir ici ...">
                                @error('Quantite')
                                    <div class="text-danger ps-3">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="text-center mt-5">
                                ...
                                <!-- Changed button onclick to submit StockForm -->
                                <button type="submit" class="btn btn-primary" onclick="prepareTags(event)" id="createstock">@lang('messages.Enregistrer')</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function prepareTags(event) {
            ...
            // Changed to createstock button
            createstock = document.getElementById('createstock')
            createstock.disabled = true; 
            const tagsInputHiden = document.querySelector('.tagsInputHiden');
            tagsInputHiden.value = tags.join("\n"); 
            // Changed to submit StockForm
        ...
        // Drag and drop functions remain the same
