...
<head>
    ...
    <title>MyApp : Facture {{$client  }} N°  {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    <div class="alert" title="your height > 1071">
            ...
            <g transform="matrix(0.42 0 0 0.42 12 12)">
                <g style="">
                    <g transform="matrix(1 0 0 1 0 -0.45)">
                        <linearGradient id="SVGID_XjNgYvtM25~vyE16ZqKonb_1" gradientUnits="userSpaceOnUse"
                            gradientTransform="matrix(1 0 0 1 0 0)" x1="24" y1="5.101" x2="24" y2="42">
                        ...
                        <path
                            style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: url(#SVGID_XjNgYvtM25~vyE16ZqKonb_1); fill-rule: nonzero; opacity: 1;"
                            transform=" translate(-24, -23.55)"
                            d="M 42.94 42 L 5.06 42 C 4.329470611441695 42.02079900323884 3.6460958548893982 41.64029175578513 3.279021831567629 41.00834045427095 C 2.91194780824586 40.376389152756765 2.919997289704694 39.59426254593025 3.2999999999999994 38.97 L 22.268 6.1 C 22.62527887536397 5.481247435699662 23.285505122055035 5.100087996128342 24 5.100087996128342 C 24.714494877944965 5.100087996128342 25.37472112463603 5.481247435699662 25.732 6.1 L 44.7 38.97 C 45.08000271029531 39.594262545930256 45.088052191754144 40.376389152756765 44.720978168432374 41.00834045427095 C 44.353904145110604 41.64029175578513 43.67052938855831 42.02079900323884 42.94 42 Z"
                            stroke-linecap="round" />
                    </g>
                    <g transform="matrix(1 0 0 1 0 -0.45)">
                        <linearGradient id="SVGID_XjNgYvtM25~vyE16ZqKona_2" gradientUnits="userSpaceOnUse"
                            gradientTransform="matrix(1 0 0 1 0 0)" x1="24" y1="5.101" x2="24" y2="42">
                        ...
                        <path
                            style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: url(#SVGID_XjNgYvtM25~vyE16ZqKona_2); fill-rule: nonzero; opacity: 0.5;"
                            transform=" translate(-24, -23.55)"
                            d="M 42.94 42 L 5.06 42 C 4.329470611441695 42.02079900323884 3.6460958548893982 41.64029175578513 3.279021831567629 41.00834045427095 C 2.91194780824586 40.376389152756765 2.919997289704694 39.59426254593025 3.2999999999999994 38.97 L 22.268 6.1 C 22.62527887536397 5.481247435699662 23.285505122055035 5.100087996128342 24 5.100087996128342 C 24.714494877944965 5.100087996128342 25.37472112463603 5.481247435699662 25.732 6.1 L 44.7 38.97 C 45.08000271029531 39.594262545930256 45.088052191754144 40.376389152756765 44.720978168432374 41.00834045427095 C 44.353904145110604 41.64029175578513 43.67052938855831 42.02079900323884 42.94 42 Z"
                            stroke-linecap="round" />
                    </g>
                    <g transform="matrix(1 0 0 1 0 -0.45)">
                        <linearGradient id="SVGID_XjNgYvtM25~vyE16ZqKonc_3" gradientUnits="userSpaceOnUse"
                            gradientTransform="matrix(1 0 0 1 0 0)" x1="3.585" y1="41.517" x2="35.493" y2="22.345">
                            <stop offset="0%" style="stop-color:rgb(255,211,117);stop-opacity: 0" />
                            <stop offset="38.2%" style="stop-color:rgb(255,211,116);stop-opacity: 0.008" />
                            <stop offset="52%" style="stop-color:rgb(254,209,113);stop-opacity: 0.039" />
                            <stop offset="61.9%" style="stop-color:rgb(252,206,107);stop-opacity: 0.092" />
                        ...
                        <path
                            style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: url(#SVGID_XjNgYvtM25~vyE16ZqKonc_3); fill-rule: nonzero; opacity: 0.5;"
                            transform=" translate(-24, -23.55)"
                            d="M 42.94 42 L 5.06 42 C 4.329470611441695 42.02079900323884 3.6460958548893982 41.64029175578513 3.279021831567629 41.00834045427095 C 2.91194780824586 40.376389152756765 2.919997289704694 39.59426254593025 3.2999999999999994 38.97 L 22.268 6.1 C 22.62527887536397 5.481247435699662 23.285505122055035 5.100087996128342 24 5.100087996128342 C 24.714494877944965 5.100087996128342 25.37472112463603 5.481247435699662 25.732 6.1 L 44.7 38.97 C 45.08000271029531 39.594262545930256 45.088052191754144 40.376389152756765 44.720978168432374 41.00834045427095 C 44.353904145110604 41.64029175578513 43.67052938855831 42.02079900323884 42.94 42 Z"
                            stroke-linecap="round" />
                    </g>
                    <g transform="matrix(1 0 0 1 0 -0.45)">
                        <linearGradient id="SVGID_XjNgYvtM25~vyE16ZqKond_4" gradientUnits="userSpaceOnUse"
                            gradientTransform="matrix(1 0 0 1 0 0)" x1="43.735" y1="42.528" x2="11.995" y2="21.916">
                            <stop offset="0%" style="stop-color:rgb(255,211,117);stop-opacity: 0" />
                            <stop offset="38.2%" style="stop-color:rgb(255,211,116);stop-opacity: 0.008" />
                            <stop offset="52%" style="stop-color:rgb(254,209,113);stop-opacity: 0.039" />
                            <stop offset="61.9%" style="stop-color:rgb(252,206,107);stop-opacity: 0.092" />
    ...
    <button type="button" class="btn1" onclick="window.print()">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-printer-fill"
            viewBox="0 0 16 16">
            <path
    ...
    <div id="page" class="page">
            ...
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p>Email: {{ $agence['email'] }}</p> --}}
                      <p id="titrePDF" hidden>Facture  {{$client  }} N°  {{ $numero }}</p>
            ...
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>FACTURE :
                            <input
                                style="background-color: transparent; border: transparent; font-size: 25px; font-family: 'Poppins', sans-serif;"
                                id="numero"
                                value="{{ $numero }}"
                                size="{{ strlen($numero) + 2 }}">
                            </b>


                        <input id="numero" type="hidden" value="{{ $numero }}">
                    </p>
                    <p class="header2-row2-col3" style=" width: 40%;   text-align: center;">
                        @if ($client !== 'Inconnu')
                            <b style="    font-size: 22px;">{{$client  }}</b>
                        @endif
                ...
                <div class="header2-row2">
                    ...
                    <p class="header2-row2-col2">
                        @if ($client !== 'Inconnu' && $tel !== null)
                            <b>Télephone :</b> {{ $tel }}
                            <br>
                        @endif

                        @if ($client !== 'Inconnu' && $adresse !== null)
                            
                            <b>Adresse :</b> {{ $adresse }}
                            <br>
                        @endif

                        @if ($client !== 'Inconnu' && $email !== null)
                  ...
                  <div class="header2-row2" style="margin-top: 40px;">
                    <p class="header2-row2-col1">
                    ...
                    <p class="header2-row2-col2">
                        ...
                        <b>Casablanca le, </b> <input type="text"
                            style="background-color: transparent;  border: transparent;" value="{{ $date }}"></input>
        ...
        <main>
            <table class="table">
                ...
                <tbody>
                    @foreach ($factureArticles as $article)
                        <tr class="tr1">
                            <td>{{ $N }}</td>
                            <td class="designation">
                                @if (!empty($article->Details))
                                    <p><b>{{ $article->designation ?? $article->produit }}</b></p>
                                    <ul class="uldet">
                                        @foreach (explode("\n", $article->Details) as $dt)
                                            <li>{!! $dt !!}</li>
                                        @endforeach
                                    </ul>
                                @else
                            ...
                            <td style="text-align: center;">{{ number_format($article->prix, 2, ',', ' ') }}</td>
                            <td style="text-align: center;">
                                {{ number_format($article->prix * $article->quantite, 2, ',', ' ') }}</td>
                           
                        </tr>
                        
                         @if($a == 8 && !$loop->last && ($loop->remaining >= 1))
                    ...
                    @endphp
                        ...
                        <table class="table">
                            ...
                            <thead id="thead2" style="visibility: collapse ;">
                                <tr>
                                    <th style="width: 5%;">N°</th>
                                    <th style="width: 55%;">Désignation</th>
                                    <th style="width: 10%;">Qté</th>
                ...
                <tfoot>
                    <tr class="total-row">
                        <td colspan="2"
                            style="border-style: hidden; border-top-style: solid; border-right-style: solid;"></td>
                    ...
                    @if ($total_Remise <> 0)
                        ...
                        <tr class="total-row">
                            <td colspan="2"
                                style="border-style: hidden; border-left-style: hidden; border-right-style: solid;"></td>
                    ...
                    @endif
                    <tr class="total-row">
                        <td colspan="2" style="border-style: hidden; border-right-style: solid;"></td>
                        <td colspan="2">PRIX TOTAL TTC</td>
          ...
          <footer >
            ...
            <div class="divfooter">
                ...
                <div class="footer1" style="margin-top: 30px;">
                      <p class="text"><b> La présente facture est arrétée à la somme de : </b> {{ $total_words }} TTC </p>
                    <div style="font-size: 13px;">
                        @if($reglements->count() > 0 || $paiement)
                            <p style="margin-bottom: 5px;"><b>Paiement :</b></p>
                            <ul style="margin-top: 0; padding-left: 20px; list-style-type: none;">
                                @if($reglements->count() > 0)
                                    {{-- All payments come from reglements table --}}
                                    @foreach($reglements as $reg)
                                        @if($reg->paiement && strtolower($reg->paiement->methode) === 'chèque' && $reg->num_cheque)
                                            <li>Chèque ({{ $reg->num_cheque }}) : {{ number_format($reg->montant, 2, ',', ' ') }} MAD</li>
                                        @elseif($reg->paiement && strtolower($reg->paiement->methode) === 'cheque' && $reg->num_cheque)
                                            <li>Chèque ({{ $reg->num_cheque }}) : {{ number_format($reg->montant, 2, ',', ' ') }} MAD</li>
                                        @else
                                            <li>{{ optional($reg->paiement)->methode ?? 'Autre' }} : {{ number_format($reg->montant, 2, ',', ' ') }} MAD</li>
                                        @endif
                                    @endforeach
                                @else
                                    {{-- Fallback: no reglements, show facture-level paiement --}}
                                    @if($paiement)
                                        <li>{{ $paiement }}</li>
                                    @endif
                                @endif
            ...
            <div class="footer3" id="draggableFotter" style="margin-top: 40px">
                <p><b>{{ $agence['nom'] }}</b> </br> Adresse siège : {{ $agence['adresse'] }}</p>
                <p>Compte {{ $agence['banque'] }} : {{ $agence['compte'] }} </p>
                <p>RC : {{ $agence['rc'] }} - IF : {{ $agence['if'] }} - TP : {{ $agence['tp'] }} - CNSS :
                    {{ $agence['cnss'] }} - ICE: {{ $agence['ice'] }}
                </p>
            </div>
        </footer>
    </div>
    ...
    <script type="text/javascript">
        ...
        function generatePDF() {
            ...
            var numero = document.getElementById('numero').value;
             var titre = document.getElementById('titrePDF').textContent
      var opt = {
                margin: [1, 0, 1, 0],
                filename: titre + '.pdf',
                image: {
            ...
            if (thead2) {
                thead2.style.visibility = 'visible';
            }
            ...
            setTimeout(() => {
                if (thead2) {
                    thead2.style.visibility = 'collapse';
                }
            }, 200);
        }
