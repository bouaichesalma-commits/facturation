...
<head>
    ...
    <title>MyApp : FP {{$client  }} N°  {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    ...
    <button type="" class="btn3" onclick="addRemove()">
    ...
    <a href="{{ route('factureProforma.generate-pdf', $factureProforma->id) }}" class="btn2">
            ...
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p>Email: {{ $agence['email'] }}</p> --}}
                      <p id="titrePDF" hidden>FP :  {{$client  }} N°  {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>Facture Proforma :   <input
            ...
            <table class="table">
                    ...
                    @foreach ($factureArticles as $article)
                        <tr class="tr1">
                            ...
                            <td class="designation">
                                @if (isset($article->Details) && $article->Details)
                ...
                <tfoot>
                    ...
                    <tr class="total-row">
                        ...
                        <td colspan="2">TVA {{ number_format($taux, 0, '.', '') }} %</td>
        ...
        <footer style="margin-top: 0">
            ...
            <div class="divfooter">
                <div class="footer2 draggableClass" id="draggableSig">
                    <div class="signature" id="draggable">
