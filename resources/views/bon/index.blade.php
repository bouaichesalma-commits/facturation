...
@section('content')
        ...
        <div class="d-flex py-2">
            ...
            <div class="p-2 justify-content-end">
                <a class="pull-right btn btn-primary" href="{{ route('bon.create') }}">Ajouter
                    un bon de livraison <i class="bi bi-plus-lg"></i>
                </a>
            </div>
        </div>
    @endif
    ...
    <section class="section mt-4">
        ...
        @include('bon.show')
                        ...
                        <div class="d-inline-block">
                            <a href="{{ route('bon.edit', $bon->id) }}" class="btn btn-warning" title="Éditer"
                                style="padding: 3px 9px; font-size: 16px;">
                                <i class="fas fa-edit"></i>
                            </a>
                        </div>
                        <form action="{{ route('bon.destroy', $bon->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
                         ...
                         <a href="{{ route('bon.download', $bon->id) }}" target="_blank" class="btn btn-success" title="Télécharger"
