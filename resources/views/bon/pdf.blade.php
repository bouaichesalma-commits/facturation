...
<head>
    <meta charset="UTF-8">
    <title>Bon de Livraison {{ $numero }} - {{ $client }}</title>
...
<body>
    ...
    <div class="container">
                ...
                <tr>
                    <td style="width: 48%; vertical-align: middle; padding: 0;">
                        <div style="border: 1.5pt solid #000; border-radius: 10pt; padding: 10pt; height: 35pt; text-align: center; display: flex; align-items: center; justify-content: center;">
                            <span style="font-size: 16pt; font-weight: bold;">BON DE LIVRAISON :<br>{{ $numero }}</span>
                        </div>
                    </td>
                    <td style="width: 4%;"></td>
                    <td style="width: 48%; vertical-align: middle; padding: 0;">
        ...
        <table class="items-table">
            ...
            <tbody>
                @foreach($bonArticles as $index => $article)
                    @if(!$loop->last)
                        <tr>
                            <td>{{ $index + 1 }}</td>
