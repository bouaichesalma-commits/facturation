...
<head>
    ...
    <title>MyApp : BL {{$client}} N° {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    ...
    <a href="{{ route('bon.generate-pdf', $bon->id) }}" class="btn2">
    ...
    <div id="page" class="page">
        <header id="draggableheader">
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p id="titrePDF" hidden>BL {{$client}} N° {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>Bon de livraison : <input
                ...
                <div class="header2-row2" style="margin-top: 0px;">
       ...
       <main id="draggableTabel">
            <table class="table">
                ...
                <tbody>
                    @foreach ($bonArticles as $article)
                        <tr class="tr1">
                            <td>{{ $N }}</td>
