        ...
        <div class="col-lg-12">
            <div class="card p-md-3 p-lg-4">
                <div class="card-body">
                    ...
                    <form id="factureForms" method="POST" action="{{ route('bon.update', $bon->id) }}" class="row g-3" onsubmit="return prepareForm()">
                        @csrf
                        @method('PUT')
                        ...
                        <table class="table mt-4">
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="montantRemise" id="motantRemise" value="{{ $bon->remise }}">
                            </tr>
                            <tr>
                                ...
                                <input type="hidden" name="valeurTVA" id="motantTVA" value="{{ $bon->taux * $bon->montant / 100 }}">
                            </tr>
                            <tr>
                        ...
                        <div class="text-center mt-5">
                            <a href="{{ route('bon.index') }}" class="btn btn-secondary">Retour</a>
