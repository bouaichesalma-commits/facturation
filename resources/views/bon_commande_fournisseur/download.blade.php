...
<head>
    ...
    <title>MyApp: Bon de Commande Fournisseur {{$fournisseur  }} N°  {{ $numero }}</title>
    <!-- Favicons -->
...
@php
    // $fournisseur = \App\Models\Fournisseur::where('ice', $ice)->first();
@endphp
...
<body>
    ...
    <a href="{{ route('bon_commande_fournisseur.generate-pdf', $bon->id) }}" class="btn2">
            ...
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p>Email: {{ $agence['email'] }}</p> --}}
                      ...
                      <p id="titrePDF" hidden> Bon de Commande Fournisseur {{$fournisseur  }} N°  {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1  ">
                        <b>BON DE COMMANDE:   <input
                    ...
                    <p class="header2-row2-col3" style="    width: 40%;   text-align: center;">
                        @if ($fournisseur !== 'Inconnu' && $fournisseur !== null)
                            <b style="    font-size: 22px;">{{$fournisseur  }}</b>
                        @endif

                        @if ($fournisseur !== 'Inconnu' && $ice !== null)
                            <br>
                            <b> ICE :{{ $ice }}</b>
                        @endif
                  ...
                  <div class="header2-row2"">
                    ...
                    <p class="header2-row2-col2">
                        @if ($fournisseur !== 'Inconnu' && $adresse !== null)
                            
                            <b>Ville :</b> {{ $adresse }}
                            <br>
                        @endif

                        @if ($fournisseur !== 'Inconnu' && $tel !== null)
                        ...
                        @if ($fournisseur !== 'Inconnu' && $email !== null)
        ...
        <main id="draggableTabel">
            <table class="table">
                ...
                <tfoot>
                    ...
                    <tr class="total-row">
                        <td colspan="2"
                            style="border-style: hidden ; border-left-style: hidden; ;  border-right-style: solid; ">
                        </td>
        ...
        <footer style="margin-top: 0">
            ...
            <div class="divfooter">
               ...
               <div class="footer1" style="margin-top: 30px;">
                    <p class="text"> Les tarifs ci-dessus sont valables jusqu’à épuisement des stocks. </p>
