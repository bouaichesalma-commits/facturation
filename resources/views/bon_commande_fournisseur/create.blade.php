...
@section('content')
    @php
        ...
        $lastBonCommande = DB::table('bon_commande_fournisseurs')
            ...
            <div class="col-lg-12">
                <div class="card p-md-3 p-lg-4">
                    <div class="card-body">
                        ...
                        <form id="factureForms" method="POST" action="{{ route('bon_commande_fournisseur.store') }}" class="row g-3">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                @error('fournisseur')<div class="text-danger ps-3">{{ $message }}</div>@enderror
                            </div>
