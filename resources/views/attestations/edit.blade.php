                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="equipe_id" id="equipe_id" class="form-control" required>
                                        ...
                                        @foreach ($equipes as $equipe)
                                            <option value="{{ $equipe->id }}" {{ $equipe->id == $attestation->equipe_id ? 'selected' : '' }}>{{ $equipe->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="categorieproject_id" id="categorieproject_id" class="form-control" required>
                                        ...
                                        @foreach ($categorieProjects as $categorieProject)
                                            <option value="{{ $categorieProject->id }}" {{ $categorieProject->id == $attestation->categorieproject_id ? 'selected' : '' }}>{{ $categorieProject->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="categorie_attestation_id" id="categorie_attestation_id" class="form-control" required>
                                        ...
                                        @foreach ($categorieAttestations as $categorieAttestation)
                                            <option value="{{ $categorieAttestation->id }}" {{ $categorieAttestation->id == $attestation->categorie_attestation_id ? 'selected' : '' }}>{{ $categorieAttestation->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="start_date" class="form-label">Date de début</label>
                                    <input type="date" name="start_date" id="start_date" class="form-control" value="{{ $attestation->start_date }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="end_date" class="form-label">Date de fin</label>
                                    <input type="date" name="end_date" id="end_date" class="form-control" value="{{ $attestation->end_date }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="signature_date" class="form-label">Date de signature</label>
                                    <input type="date" name="signature_date" id="signature_date" class="form-control" value="{{ $attestation->signature_date }}" required>
                                </div>
                            </div>
