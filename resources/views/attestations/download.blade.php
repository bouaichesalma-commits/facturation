...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/downloadatt.css') }}">
...
<body> 
    ...
    <button type="button" class="btn2" onclick="generatePDF()">
    ...
    <div id="page" class="page">
            ...
            <div class="header2" >
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>{{$categorieAttestations}}</b>
                        <input id="numero" type="hidden" value="1">
                    </p>
                </div>
            </div>
        ...
        <footer style="margin-top: 37px;">
        
        <div class="divfooter">
            <div class="footer1" id="draggableMode" >
                <p class="text"> Je soussigné, Monsieur Mohamed RACHIDI, fonction Gérant de la société MyApp.
                </p>
                <p>Atteste que le stagiaire {{$equipe}}, a effectué un stage dans notre entreprise en {{$categorieequipe}},  
                </br>du {{$start_date}} au {{$end_date}}.
                    </p>
                    <p>Nous délivrons la présente attestation pour servir et valoir ce que de droit.</p>
            </div>
            <div class="ft">
                
                    Fait à: Fès, le: {{$signature_date}}
                </br>
            ...
            <div class="footer3" id="draggableFotter" >
                <p>MyApp SARL (AU) au capital de 100.000 Dh. 93 Avenue la Marhce Verte Lot Ouafae 1. Rte Sefrou FES.</p>
                <p>Banque Populaire Soundouss Fès, Numéro de compte: 21211 4972461 000 6-Code Swift (BIC)-BCPОМАМС</p>
                <p>RC: 38795 - IF: 40494350 - 
                    TP: 14285038
                    CNSS 9167827-ICE: 000520780000060</p>
            </div>
        </footer>
    </div>
    ...
    <script type="text/javascript">
        ...
        function generatePDF() {
            ...
            var opt = {
                margin: 0,
                filename: 'Attestation '+numero+'.pdf',
                image: {
                    type: 'jpeg',
                    quality: 1
                },
