...
$lastbon = DB::table('bon_de_sortie')
        ...
        <div class="col-lg-12">
            <div class="card p-md-3 p-lg-4">
                <div class="card-body">
                    ...
                    <form id="factureForms" method="POST" action="{{ route('bon_sortie.store') }}" class="row g-3" onsubmit="return prepareForm()">
                        @csrf
                      ...
                      <div class="row gx-2 mt-4">
                        ...
                        <div class="text-center mt-5">
                            <a href="{{ route('bon_sortie.index') }}" class="btn btn-secondary">Retour</a>
