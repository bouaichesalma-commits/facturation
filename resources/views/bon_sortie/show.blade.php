    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold">bon de Sortie Nº {!! $bon['num']  == "loading" ? "<div class='spinner-border spinner-border-sm text-secondary' role='status'><span class='visually-hidden'>Loading...</span></div>" : $bon['num'] !!}</h5>
    ...
    <td>
        ...
        {{ number_format($ttc, 2, '.', '') }} Dh
                ...
                <div class="text-center d-flex flex-md-row flex-column justify-content-center flex-wrap gap-2 mt-5 mb-2">
                    ...
                    <a href="{{ route('bon_sortie.edit', $bon['id']) }}" class="btn btn-edit">
                        <i class="bi bi-pencil-square"></i> Modifier
                    </a>
                    @endif

                    @if (auth()->user()->can('imprimer bon'))
                    <a href="{{ route('bon_sortie.download', $bon['id']) }}" target="_blink" class="btn btn-facture">
