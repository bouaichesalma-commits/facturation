...
<head>
    ...
    <title>MyApp: BS {{$client}} N° {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    ...
    <a href="{{ route('bon_sortie.generate-pdf', $bon->id) }}" class="btn2">
            ...
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p>Email: {{ $agence['email'] }}</p> --}}
                      <p id="titrePDF" hidden>BS {{$client}} N° {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>Bon de Sortie :   <input
