<div class="modal fade" wire:ignore.self id="deleteModel{{ $user['id'] }}" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
            ...
            <div class="modal-body text-center p-3">
                ...
                <div>
                    <form action="{{ route('users.destroy', $user['id']) }}" method="POST">
                        ...
                        <button type="button" onclick="event.preventDefault();this.disabled = true; this.closest('form').submit();" 
