<div class="modal fade" wire:ignore.self id="deleteModel{{ $bon_commande_id }}" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content p-2">
            ...
            <div class="modal-body text-center p-3">
                ...
                <div>
                    <form action="{{  route('bon_commande.destroy', $bon_commande_id) }}" method="POST">
                        @csrf
                        @method('DELETE')
