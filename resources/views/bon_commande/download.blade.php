...
<head>
    ...
    <title>MyApp: Bon de commande {{$client  }} N°  {{ $numero }}</title>
    <!-- Favicons -->
...
@php
    // $client = \App\Models\Client::where('ice', $ice)->first();
@endphp
...
<body>
    ...
    <a href="{{ route('bon_commande.generate-pdf', $bon_commande->id) }}" class="btn2">
            ...
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p>Email: {{ $agence['email'] }}</p> --}}
                      ...
                      <p id="titrePDF" hidden> Bon de commande {{$client  }} N°  {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
