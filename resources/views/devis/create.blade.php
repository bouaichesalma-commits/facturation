...
@section('content')
    @php
        ...
        $lastDevis = DB::table('devis')
            ->whereYear('date', $currentYear)
            ->orderBy('created_at', 'desc')
            ->value('num');

        if ($lastDevis) {
            $lastNumPrefix = (int) explode('/', $lastDevis)[0];
            ...
            <div class="col-lg-12">
                <div class="card p-md-3 p-lg-4">
                    <div class="card-body">
                        ...
                        <form id="factureForms" method="POST" action="{{ route('devis.store') }}" class="row g-3">
                            @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('nom_commercial') is-invalid @enderror"
                                    id="nom_commercial" name="nom_commercial" value="{{ old('nom_commercial') }}">
    ...
    <script>
        ...
        function setupEventListeners() {
            ...
            document.getElementById('InpRemis').addEventListener('input', function () {
                validateDiscount();
                calculateTotals();
            });
            // Handled above
