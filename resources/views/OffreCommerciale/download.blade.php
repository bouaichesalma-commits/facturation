...
<head>
    ...
    <title>MyApp: Offre Commerciale {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    ...
    <a href="{{ route('offreCommerciale.generate-pdf', $OffreCommerciale->id) }}" class="btn2">
    ...
    <div id="page" class="page">
        <header id="draggableheader" class="mg-bottom-OBJ">
            <div class="header1">
            ...
            <div class="header2 mg-top-eco">
                <div class="header2-row1 mg-left-10 mg-bottom-ECO">
                    <p class="header2-row1-col112">
                        <b style="color: #003b88">OFFRE COMMERCIALE </b>
                        <input id="numero" type="hidden" value="{{ $numero }}">
                    </p>
                </div>
                <div class="header2-row1 mg-left-10">
                    <p class="header2-row2-col112">
                        <b style="color: #00d3ab">{{ strtoupper($objet) }}</b>
                    </p>
                </div>
            </div>
        </header>
        ...
        <div class="divfooter">
            {{-- <div class="footer1" id="draggableMode" >
                <p class="text"><b> Le présent Reçu De Paiement est arrêté à la somme de :</b> {{ $total_words }} {{ $tva ? 'TTC' : 'HT' }}</p>
                <ul>
                    <li>
                        Modalités de paiement :
                        Chèque, Espèce, Virement bancaire
                        <span>...</span>
                    </li>
                    <li>Conditions de règlement : 50 % à la commande et 50%à la livraison.</li>
                    <li>Délai de réalisation : {{ $delai }} </li>
                </ul>
            </div> --}}
            <div class="footer2Sin draggableClass" id="draggableSig">
                <div class="signature">
...
function generatePDF() {
    ...
    var opt = {
        margin: 0,
        filename: 'OffreCommerciale Nº '+numero+'.pdf',
        image: {
            type: 'jpeg',
            quality: 1
        },
    ...
    html2pdf().set(opt).from(element).save();
        ...
        $( function() {
            ...
            // $( "#draggableheader" ).draggable();1054.25
