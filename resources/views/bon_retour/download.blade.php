...
<head>
    ...
    <title>MyApp : Bon de retour {{$client}} N° {{ $numero }}</title>
    <!-- Favicons -->
...
<body>
    ...
    <a href="{{ route('bon_retour.generate-pdf', $bon->id) }}" class="btn2">
        ...
        <header id="draggableheader">
            <div class="header1">
                ...
                <div class="info-header1">
                    ...
                    <p id="titrePDF" hidden>Bon de retour {{$client}} N° {{ $numero }}</p>
                </div>
            </div>
            <div class="header2">
                <div class="header2-row1">
                    <p class="header2-row1-col1">
                        <b>Bon de retour : <input
