...
$lastbon = DB::table('bon_de_retour')
    ->whereYear('date', $currentYear)
    ->orderBy('created_at', 'desc')
    ->value('num');

if ($lastbon) {
    if (strpos($lastbon, '/') !== false) {
        $lastNumPrefix = (int) explode('/', $lastbon)[0];
    } else {
        $lastNumPrefix = (int) $lastbon;
    }
...
$nextNum = sprintf('%05d/%s', $nextNumRaw, $shortYear);
@endphp
        ...
        <div class="col-lg-12">
            <div class="card p-md-3 p-lg-4">
                <div class="card-body">
                    ...
                    <form id="factureForms" method="POST" action="{{ route('bon_retour.store') }}" class="row g-3" onsubmit="return prepareForm()">
                        @csrf
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('num') is-invalid @enderror" 
                                   id="inputNum" name="num" value="{{ old('num', $nextNum) }}" >
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('date') is-invalid @enderror" 
                                   id="inputDate" name="date" value="{{ old('date', now()->toDateString()) }}">
                        ...
                        <div class="row gx-2 mt-4">
                            <div class="col-3">
                                <select name="etatremise" id="remise" class="form-select">
                                    ...
                                    <option value="pourcentage" @selected(old('etatremise') == 'pourcentage')>Pourcentage</option>
                                    <option value="montant" @selected(old('etatremise') == 'montant')>Montant fixe</option>
                                </select>
                            </div>
                            <div class="col-2">
