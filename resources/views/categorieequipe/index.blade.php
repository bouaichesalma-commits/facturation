<!-- resources/views/categorieequipes/index.blade.php -->
...
@if (auth())
    <div class="d-flex py-2">
        ...
        <div class="p-2 justify-content-end">
            <a class="pull-right btn btn-primary" href="{{ route('categorieequipe.create') }}">Ajouter un Categorie Equipe <i class="bi bi-plus-lg"></i></a>
        </div>
    </div>
@endif
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap">
                                                <div class="d-inline-flex me-2 mb-2">
                                                    ...
                                                    @if (auth())
                                                    <!-- Edit button -->
                                                    <a href="{{ route('categorieequipe.edit', $category->id) }}" class="btn text-warning">
                                                    ...
                                                    <div class="modal fade" id="deleteModal{{ $category->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $category->id }}" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form action="{{ route('categorieequipe.destroy', $category->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
